...
const moviesUrl = 'https://api.themoviedb.org/3/discover/movie?include_adult=false&include_video=false&language=en-US&page=1&sort_by=popularity.desc';
const favTvsapiUrl = 'https://api.themoviedb.org/3/account/21780644/favorite/tv?language=en-US&page=1&sort_by=created_at.asc';
const personsUrl = 'https://api.themoviedb.org/3/person/popular?language=en-US&page=1';
